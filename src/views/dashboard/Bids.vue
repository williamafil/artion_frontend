      ...
      <table class="table-auto border-collapse w-full">
        <thead>
          ...
          >
            ...
            <th class="px-4 py-2 " style="background-color:#f8f8f8">我的出價</th>
            <th class="px-4 py-2 " style="background-color:#f8f8f8">時間</th>
          </tr>
        </thead>
        <tbody class="text-sm font-normal text-gray-700">
          ...
          >
            <td class="px-4 py-4">{{ item.auction.title }}</td>
            <td class="px-4 py-4">{{ item.auction.author_name }}</td>
            <td class="px-4 py-4">{{ item.bid | separator | dollar }}</td>
            <td class="px-4 py-4">{{ item.created_at | date }}</td>
          </tr>
        </tbody>
      </table>
    </div>
...
<script>
import { follows } from '@/service/api';
